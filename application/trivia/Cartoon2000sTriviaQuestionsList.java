...
public class Cartoon2000sTriviaQuestionsList {
    private static ArrayList<Cartoon2000sTriviaQuestion> questions = new ArrayList<>(); // Initialize the list
    ...
    public Cartoon2000sTriviaQuestionsList() {
        if (questions.isEmpty()) { // Check if the list is empty before loading questions
            try (
